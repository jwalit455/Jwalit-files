...
class Snake extends JFrame implements KeyListener, Runnable {
    ...
    Point bfp = new Point();
    Thread myt;
    boolean item = false, runl = false, runr = true, runu = true, rund = true, bonusflag = true;
    Random r = new Random();
    JMenuBar mymbar;
    ...
    Snake() {
        ...
        bonusitem = new JButton();
        bonusitem.setEnabled(false);
    ...
    public void creatbar() {
        ...
        creator.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                JOptionPane.showMessageDialog(p2, "Name :Jwalit b\nRollno :5406731093\nSub :cse\ninstitute :sust");
            }
        });
    ...
    void moveForward() {
        ...
        if (lbx[0] == lbx[gu - 1] && lby[0] == lby[gu - 1]) {
            ...
            if (score % 50 == 0 && bonusflag == true) {
                p1.add(bonusitem);
                bonusitem.setBounds((10 * r.nextInt(50)), (10 * r.nextInt(25)), 15, 15);
                bfp = bonusitem.getLocation();
                bonusflag = false;
            }
        }
